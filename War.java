...
public class War {
	public static List<Card> playerOneHand = null;
	public static List<Card> playerTwoHand = null;
...
//		printStart();
		...
		System.out.println("Player one hand size is "+ playerOneHand.size());
		for(int j = 0; j < 26; j++)
		{
		...
		System.out.println("Player two hand size is "+ playerTwoHand.size());
		for(int j = 0; j < 26; j++)
		{
		...
		while(playerOneHand.size() != 0 && playerTwoHand.size() != 0)
		{
			...
			// THIS LINE THREW {java.util.ConcurrentModificationException}
	...
	public static void getInput()
	{
		...
		while(!p||!q)
		{
			...
			if(p)
			{
				System.out.println("P1: " + playerOneHand.get(0).getName());
			}
			else
			{
			...
			if(q)
			{
				System.out.println("P2: " + playerTwoHand.get(0).getName());
			}
			else
			{
